...
def modify_patient_record():
               ...
               if modify_patient_name in patients:
                  patients['patient_name']=input("enter new name:")
                  patients['age']=input("enter new age:")
                  patients['doctor_name']=input("enter new doctor name:")
                  patients['disease']=input("enter new disease:")
                  patients['blood_group']=input("enter new blood group:")
